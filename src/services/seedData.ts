...
const ONBOARDING_TASKS: OnboardingTask[] = [
  ...
  {
    title: 'Check the Goals tab to see your progress',
    description:
      "Every task can be linked to a goal. As you complete tasks, the goal's progress bar fills up. This task is part of your \"Learn how DO works\" goal — completing it moves the bar forward. Head to the Goals tab to see it, then come back here.",
    estimatedMinutes: 2,
    offsetMinutes: 4,
  },
  {
  ...
  {
    title: 'Switch to the Tasks tab and back',
    description:
      "The Tasks tab shows everything as a traditional list — grouped by goal so you can see the big picture. But Focus is where the magic happens — one thing at a time. Try switching tabs.",
    estimatedMinutes: 1,
    offsetMinutes: 2,
  },
  {
